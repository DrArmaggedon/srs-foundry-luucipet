...
The complete RTM covers **186 rows** across all sections. A summary of traceability links is provided below.

| Requirement ID | Title | Source Tags | Section | Status | Verification Method |
|:---------------|:------|:------------|:--------|:-------|:--------------------|
| --- | --- | --- | --- | --- | --- |
...
**Full RTM data:** 186 rows spanning all 18 sections. Detailed RTM available in CSV format (`rtm-part-a.csv`, `rtm-part-b.csv`).
...
**Document Statistics:** 363 requirements · 31 defined terms · 186 RTM rows · 18 sections · 0 unresolved conflicts
...
| SRS-INT-0003 | Minimum Concurrent Collar Sessions | High | Stable | Test |
| SRS-INT-0004 | Default BLE Advertising Interval | Medium | Stable | Test |
| SRS-INT-0005 | Configurable Advertising Interval Range | Medium | Stable | Test |
| SRS-INT-0006 | Advertising Continuity During Active Connection | Medium | Stable | Test |
| SRS-INT-0007 | BLE Address Randomization | High | Stable | Test |
| SRS-INT-0008 | Minimum BLE Transmit Power | Medium | Stable | Test |
| SRS-INT-0009 | Minimum BLE Open-Air Range | High | Stable | Test |
| SRS-INT-0010 | BLE Link-Layer Encryption | Critical | Stable | Test |
| SRS-INT-0011 | BLE Pairing via LE Secure Connections | Critical | Stable | Test |
| SRS-INT-0012 | QR Out-of-Band Pairing Mechanism | High | Stable | Test |
| SRS-INT-0013 | BLE Radio Regulatory Conformance | Critical | Stable | Test |
| SRS-INT-0014 | Bluetooth SIG Qualification | Critical | Stable | Inspection |
| SRS-INT-0015 | RF Human-Exposure Assessment | Medium | Tentative | Analysis |
...
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.3 · PRD §12.1                                               |
...
|------------------|---------------------------------------------------------------------|
| **SRS-INT-0012** | **QR Out-of-Band Pairing Mechanism**                                |
| **Statement**    | The system shall support out-of-band BLE pairing initiated via a QR-code-based exchange between the collar device and the base station. |
| **Rationale**    | Defines the device/base-station-side OOB pairing mechanism. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §6.3 · PRD §8.2                                                 |
...
|------------------|---------------------------------------------------------------------|
| **SRS-INT-0013** | **BLE Radio Regulatory Conformance**                                |
| **Statement**    | The BLE radio interface shall conform to the radio-equipment regulations applicable in each target market, including FCC 47 CFR Part 15 Subpart C (US), RED 2014/53/EU (EU), UK Radio Equipment Regulations 2017 (UK), ISED RSS-247 (CA), and AS/NZS 4268:2017 (AU/NZ). |
| **Rationale**    | Market access for an intentional 2.4 GHz radiator requires conformance to each target market's radio-equipment regulation. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
...
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
| **Traceability** | PRD §13.1 · Bluetooth SIG Qualification                             |
...
|------------------|---------------------------------------------------------------------|
| **SRS-INT-0015** | **RF Human-Exposure Assessment**                                    |
| **Statement**    | The BLE radio interface should undergo an RF human-exposure assessment against IEC 62311 / FCC 47 CFR §1.1310 for continuously worn 2.4 GHz transmission. |
| **Rationale**    | A continuously worn 2.4 GHz transmitter plausibly triggers per-market RF-exposure assessment; applicability and thresholds are per-market indicative and not yet confirmed. |
| **Priority**     | Medium                                                              |
| **Stability**    | Tentative                                                           |
| **Verification** | Analysis                                                            |
| **Traceability** | PRD §13.1                                                           |
...
|------------------|---------------------------------------------------------------------|
| **SRS-INT-0016** | **Wi-Fi Radio Band and Standard**                                   |
| **Statement**    | The base station shall implement a Wi-Fi radio interface operating in the 2.4 GHz band conforming to IEEE 802.11 b/g/n. |
| **Rationale**    | Defines the base-to-cloud uplink radio band and PHY/MAC standard. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
...
| **SRS-INT-0017** | **Cloud Uplink Transport Encryption**                               |
| **Statement**    | The base station shall encrypt all Wi-Fi-based cloud uplink traffic using TLS 1.3. |
| **Rationale**    | Mandated transport-layer confidentiality/integrity mechanism for base-station-to-cloud traffic. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §6.5 · PRD §11.2 · PRD §12.3                                   |
...
| **SRS-INT-0019** | **Minimum Wi-Fi Uplink Signal Condition**                           |
| **Statement**    | The base station shall maintain cloud connectivity under a home Wi-Fi signal condition of at least −70 dBm RSSI at 2.4 GHz with at least 256 kbps sustained uplink throughput. |
| **Rationale**    | Resolves the PRD's unbounded "reliable Wi-Fi" assumption with an engineered numeric floor. |
| **Priority**     | Medium                                                              |
| **Stability**    | Volatile                                                            |
| **Verification** | Test                                                                |
| **Traceability** | A-0009                                                              |
...
|------------------|---------------------------------------------------------------------|
| **SRS-INT-0020** | **Wi-Fi Radio Regulatory Conformance**                              |
| **Statement**    | The Wi-Fi radio interface shall conform to the radio-equipment regulations applicable in each target market, including FCC 47 CFR Part 15 Subpart C (US) and RED 2014/53/EU (EU). |
| **Rationale**    | Market access for the base station's Wi-Fi radio requires conformance to each target market's radio-equipment regulation. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
...
| SRS-INT-0024 | Default GNSS Fix Interval | Medium | Stable | Test |
| SRS-INT-0025 | A-GPS Assistance Data Delivery | High | Stable | Test |
| SRS-INT-0026 | A-GPS Data Validity Window | Medium | Stable | Test |
| SRS-INT-0027 | GNSS Power Gating During HOME State | High | Stable | Test |
| SRS-INT-0028 | GNSS Fix Acquisition Timeout | High | Stable | Test |
| SRS-INT-0029 | Warm GNSS Time-to-First-Fix Ceiling | Medium | Stable | Test |
| SRS-INT-0030 | GNSS Exemption Status | Medium | Tentative | Analysis |
...
| **SRS-INT-0023** | **Configurable GNSS Fix Interval Range**                            |
| **Statement**    | The Max collar variant shall support a user-configurable GNSS fix interval between 30 minutes and 24 hours inclusive. |
| **Rationale**    | Allows the fix cadence to be tuned against the battery-life-vs-fix-interval trade-off. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §4.1 · PRD §10.2.2                                              |
...
| **SRS-INT-0024** | **Default GNSS Fix Interval**                                       |
| **Statement**    | The Max collar variant shall apply a default GNSS fix interval of 2 hours. |
| **Rationale**    | Establishes the out-of-box fix cadence consistent with the stated ≥45-day battery-life target. |
| **Priority**     | Medium                                                              |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §4.1 · PRD §10.2.2                                              |
...
| **SRS-INT-0027** | **GNSS Power Gating During HOME State**                             |
| **Statement**    | The Max collar variant shall disable the GNSS interface while the device-local home/away state machine determines the HOME state. |
| **Rationale**    | The GNSS smart power gate underpins the stated Max battery-longevity targets. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.2.2 · PRD §6.4 · A-0016 |
...
| **SRS-INT-0030** | **GNSS Intentional-Radiator Exemption Status**                      |
| **Statement**    | The GNSS receive-only interface should be treated as exempt from intentional-radiator certification requirements in each target market, pending per-market confirmation. |
| **Rationale**    | The PRD defers this exemption determination to Regulatory Lead confirmation per market. A SHOULD rather than SHALL reflects the indicative status. |
| **Priority**     | Medium                                                              |
| **Stability**    | Tentative                                                           |
| **Verification** | Analysis                                                            |
| **Traceability** | PRD §13.1                                                           |
...
| SRS-INT-0034 | Full-Charge Time Ceiling | High | Stable | Test |
| SRS-INT-0035 | IP67 Rating When Undocked | Critical | Stable | Test |
| SRS-INT-0036 | Charging Socket Self-Drainage | Medium | Volatile | Test |
| SRS-INT-0037 | Charging-Access Removal Rotation | High | Stable | Demonstration |
| SRS-INT-0038 | Device-Absent Socket Probe Clearance | High | Volatile | Test |
...
|------------------|---------------------------------------------------------------------|
| **SRS-INT-0031** | **Pogo-Pin Contact Count and Function**                             |
| **Statement**    | The charging interface between the collar device and the charging cradle shall use a 2-contact pogo-pin arrangement carrying VBUS and GND. |
| **Rationale**    | Defines the minimal electrical contact interface for charging. Cross-variant identical geometry is established by SRS-COMP-0003. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
...
| **SRS-INT-0033** | **First-Attempt Docking Seating Rate**                              |
| **Statement**    | The magnetic charging alignment shall achieve correct first-attempt seating in at least 90% of docking attempts made at an approach distance of up to 5 mm. |
| **Rationale**    | Bounds the usability of the magnetic docking mechanism to a measurable success rate. |
| **Priority**     | Medium                                                              |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.3.5                                                       |
...
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §6.6 · PRD §10.5 · PRD §13.4                                   |
...
| **SRS-INT-0036** | **Charging Socket Self-Drainage**                                   |
| **Statement**    | The charging socket shall drain to no more than 0.2 mL of residual water within 15 seconds after being filled with 5 mL of water, with the collar device held in its normal worn orientation (socket facing 0 to 45 degrees from vertical). |
| **Rationale**    | PRD states the socket "shall be self-draining" with no quantified acceptance criterion. Assumption A-0023 resolves this gap with engineered drainage criteria. |
| **Priority**     | Medium                                                              |
| **Stability**    | Volatile                                                            |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.5 · PRD §10.1.3.5 · A-0023                                 |
...
| **Stability**    | Volatile                                                            |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.3.5 · A-0010                                              |
...
| SRS-INT-0044 | Detent Release Torque Window | High | Stable | Test |
| SRS-INT-0045 | Twist-Lock Axial Retention Floor | Critical | Stable | Test |
| SRS-INT-0046 | Engagement Insertion Force Ceiling | Medium | Stable | Test |
| SRS-INT-0047 | Engagement Rotation Torque Ceiling | High | Stable | Test |
| SRS-INT-0048 | Engagement Feedback | Medium | Stable | Demonstration |
| SRS-INT-0049 | Magnetic Engagement Assist Range | Low | Stable | Test |
| SRS-INT-0050 | Tool-Free Twist-Lock Operation | High | Stable | Demonstration |
| SRS-INT-0051 | Twist-Lock Engagement Time Ceiling | Low | Stable | Test |
...
| **SRS-INT-0041** | **Lug Ramp Self-Locking Profile**                                   |
| **Statement**    | The Twist-Lock lug ramp shall have a trapezoidal profile with an 8-degree self-locking angle. |
| **Rationale**    | The ramp angle achieves self-locking behavior without requiring a separate latch. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
| **Traceability** | PRD §10.1.3.2a                                                      |
...
| **SRS-INT-0044** | **Detent Release Torque Window**                                    |
| **Statement**    | The Twist-Lock detent shall release within a torque window of 0.08 to 0.10 N·m. |
| **Rationale**    | Bounds the rotational effort at which the detent yields, balancing inadvertent-release resistance against ease of intentional removal. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.3.2a                                                      |
...
| **SRS-INT-0045** | **Twist-Lock Axial Retention Floor**                                |
| **Statement**    | The Twist-Lock interface shall withstand an axial pull-off force greater than 100 N without releasing. |
| **Rationale**    | The Twist-Lock is explicitly not a breakaway mechanism; it must retain the device under normal and inertial loading, distinct from the Zone 2 Fuse Tab governed under Safety Requirements. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.3.1 · PRD §10.1.3.2a                                     |
...
| **SRS-INT-0047** | **Twist-Lock Engagement Rotation Torque Ceiling**                   |
| **Statement**    | The Twist-Lock interface shall require no more than 0.10 N·m of rotational torque to engage or release. |
| **Rationale**    | Bounds the rotational effort required of the owner during the engage/remove workflow. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.1 · PRD §10.1.3.2a                                       |
...
| **SRS-INT-0049** | **Magnetic Engagement Assist Range**                                |
| **Statement**    | The Twist-Lock interface shall provide magnetic engagement assistance effective at an approach distance of up to 5 mm. |
| **Rationale**    | Assists initial alignment of the device onto the CCF socket before rotation. Distinct from the charging-dock magnetic alignment in SRS-INT-0033. |
| **Priority**     | Low                                                                 |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.3.2a                                                      |
...
| ID | Short Title | Priority | Stability | Verification |
|----|-------------|----------|-----------|--------------|
| SRS-INT-0052 | Common Protocol Across Variants | High | Stable | Inspection |
| SRS-INT-0053 | Payload Type — Classification Record | High | Stable | Test |
| SRS-INT-0054 | Payload Type — BLE Sighting Report | High | Stable | Test |
| SRS-INT-0055 | Payload Type — Cloud Downlink | High | Stable | Test |
| SRS-INT-0056 | Base Station Payload Content Opacity | High | Stable | Inspection |
| SRS-INT-0057 | Collar Buffer Retention Pending ACK | High | Stable | Test |
| SRS-INT-0058 | No FIFO Clear on Disconnect Alone | High | Stable | Test |
| SRS-INT-0059 | Sequence-Loss Detection | High | Stable | Test |
| SRS-INT-0060 | Corruption-Free Record Forwarding | High | Stable | Test |
...
| **SRS-INT-0052** | **Common Device-Enforced Protocol Across Variants**                 |
| **Statement**    | The system shall use a common device-enforced BLE application protocol shared across all collar and base-station firmware variants. |
| **Rationale**    | A single shared protocol avoids per-variant protocol fragmentation. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
| **Traceability** | PRD §4.3 · A-0001                                                   |
...
|------------------|---------------------------------------------------------------------|
| **SRS-INT-0054** | **Payload Type — BLE Sighting Report**                              |
| **Statement**    | The device-enforced protocol shall support transport of BLE sighting reports, each comprising device identifier, RSSI, timestamp, and base station identifier, as a distinct payload type. |
| **Rationale**    | Sighting reports are the data basis for home/away geo-fence determination and are reported independent of behavioral-data sync. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
...
| **SRS-INT-0056** | **Base Station Payload Content Opacity**                            |
| **Statement**    | The base station shall relay collar behavioral payloads to the cloud without semantically interpreting their content. |
| **Rationale**    | Keeps behavioral-data interpretation logic on the collar/cloud endpoints only, avoiding base-station firmware dependency on payload semantics. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
| **Traceability** | PRD §8.3                                                            |
...
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.2 · PRD §13.4 · IEC 60529                                 |
...
| **SRS-HW-0008** | **Charging Socket Self-Drainage Criterion**                         |
| **Statement**    | The device-facing charging socket shall drain to no more than 0.2 mL of residual water within 15 seconds after being filled with 5 mL of water, with the collar device held in its normal worn orientation (socket facing 0 to 45 degrees from vertical). |
| **Rationale**    | PRD states "shall be self-draining" with no quantified criterion. Assumption A-0023 resolves this gap. Identical criterion applied in SRS-INT-0036. |
| **Priority**     | Medium                                                              |
| **Stability**    | Volatile                                                            |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.5 · PRD §10.1.3.5 · A-0023                                 |
...
| **SRS-HW-0012** | **No Chrome or Nickel Plating on Animal-Contact Surfaces**          |
| **Statement**    | Animal-contact surfaces of the device and CCF shall not use chrome or nickel plating. |
| **Rationale**    | Chrome/nickel are common animal-contact allergens. Exclusion is required for the pet-contact material safety case. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
| **Traceability** | PRD §10.1.2 · PRD §13.2                                             |
...
| **SRS-HW-0014** | **Accelerometer Output-Data-Rate Capability**                       |
| **Statement**    | The collar device accelerometer shall support an output data rate of no less than 50 Hz. |
| **Rationale**    | The classification engine requires ≥50 Hz sampling; the hardware must be capable of sustaining it. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.2.1                                                         |
...
| **SRS-HW-0018** | **BLE 5.x Radio Presence**                                          |
| **Statement**    | The collar device shall incorporate a Bluetooth Low Energy 5.x radio. |
| **Rationale**    | The BLE radio is the sole collar-to-base-station communication component. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
...
| **SRS-HW-0019** | **BLE Radio Transmit-Power Capability**                             |
| **Statement**    | The collar device BLE radio shall be capable of a transmit power of no less than +8 dBm. |
| **Rationale**    | The radio hardware must be capable of the +8 dBm floor that the range requirement depends on. |
| **Priority**     | Medium                                                              |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.3                                                           |
...
| **SRS-HW-0020** | **Mini Minimum Cell Capacity**                                      |
| **Statement**    | The Mini collar device shall incorporate a battery cell of no less than 120 mAh nominal capacity. |
| **Rationale**    | The PRD §10.4 minimum is the governing cell-capacity floor. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
| **Traceability** | PRD §10.4 · A-0006                                                  |
...
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.4 · IEC 62133-2:2017                                       |
...
| **SRS-HW-0023** | **Battery Transport-Safety Qualification**                          |
| **Statement**    | The collar device battery shall pass UN 38.3 qualification testing before pilot production. |
| **Rationale**    | UN 38.3 is mandatory for lithium-cell transport. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.4 · UN 38.3                                                 |
...
|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-HW-0026** | **Non-Volatile Classification Storage Capacity**                    |
| **Statement**    | The collar device shall incorporate non-volatile storage sufficient to retain no less than 30 days of behavioral-classification summary data. |
| **Rationale**    | The ≥30-day on-device retention floor requires a matching physical NV storage component. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
...
| **SRS-HW-0028** | **Compute Architecture with DMA and Hardware Root of Trust**        |
| **Statement**    | The collar device compute subsystem shall provide direct-memory-access peripheral access and a hardware root of trust. |
| **Rationale**    | DMA peripheral access supports low-power sensing offload; the hardware root of trust is the physical anchor for secure boot. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
...
| **SRS-ENV-0001** | **Device Operating Temperature Range**                              |
| **Statement**    | The collar device shall operate within an ambient temperature range of −20 °C to +50 °C without loss of function. |
| **Rationale**    | Defines the outdoor/indoor thermal envelope the device must remain functional across for pet-wearable use. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §12.5                                                           |
...
| **SRS-ENV-0002** | **Device Storage Temperature Range**                                |
| **Statement**    | The collar device shall withstand storage, while non-operating, at ambient temperatures between −30 °C and +60 °C without degradation of subsequent operational performance. |
| **Rationale**    | Bounds the non-operating thermal envelope for warehousing, shipping, and retail-shelf conditions. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §12.5                                                           |
...
| **SRS-ENV-0003** | **CCF Thermal-Cycling Exposure**                                    |
| **Statement**    | The CCF shall be subjected to a thermal-cycling exposure regime spanning −20 °C to +50 °C, per the IEC 60068-2-14 Test Na profile, without loss of function. |
| **Rationale**    | PRD states the temperature-cycling range without specifying a cycle count, dwell, or ramp profile. A-0003 supplies the IEC 60068-2-14 Test Na default. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §12.5 · A-0003                                                  |
...
| **SRS-ENV-0004** | **Device Damp-Heat Exposure**                                       |
| **Statement**    | The collar device should withstand a damp-heat exposure per IEC 60068-2-78 without loss of function. |
| **Rationale**    | PRD identifies damp-heat testing as a recommended qualification test supplementing the IP67 ingress rating. |
| **Priority**     | Medium                                                              |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §13.4                                                           |
...
|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-ENV-0005** | **No IP67 Claim for CCF-Mated Configuration**                       |
| **Statement**    | Product documentation and marketing materials shall not state or imply an IP67 or equivalent ingress-protection rating for the collar device while mated to any CCF. |
| **Rationale**    | The IP67 rating is qualified only for the device-standalone, unmated condition. This prevents unsubstantiated ingress claims for the CCF-mated wear condition. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
| **Traceability** | PRD §4.1 · PRD §13.4                                                |

<a id="req-env-0006"></a>

|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-ENV-0006** | **Independent Laboratory IP67 Confirmation**                        |
| **Statement**    | The IP67 ingress-protection rating claimed for the collar device shall be confirmed by an independent, accredited test laboratory and documented in a test report prior to product launch. |
| **Rationale**    | PRD requires the device-standalone IP67 claim to be documented and confirmed with lab, establishing an independent-verification gate. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
| **Traceability** | PRD §13.4                                                           |
...
|------------------|---------------------------------------------------------------------|
| **SRS-ENV-0007** | **Twist-Lock Channel Water-Ingress Exclusion**                      |
| **Statement**    | The Twist-Lock lug channels shall exclude water ingress along the channel path when subjected to the IP67 immersion test. |
| **Rationale**    | PRD states the Twist-Lock channels present "no water path." This is the functional test-level counterpart to the structural solid-section requirement in SRS-HW-0007. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §13.4                                                           |
...
| **SRS-ENV-0008** | **Ingress Seal-Boundary Interior Placement**                        |
| **Statement**    | The ingress-protection seal boundary shall be located on the interior side of the enclosure assembly such that it is not directly exposed on any externally accessible mating surface. |
| **Rationale**    | Protects the seal from direct mechanical wear and contamination that would otherwise degrade the IP67 seal over the product's service life. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
| **Traceability** | PRD §13.4                                                           |
...
| **SRS-ENV-0010** | **Mechanical Shock Resistance**                                     |
| **Statement**    | The collar device should withstand mechanical shock per IEC 60068-2-27 without loss of function. |
| **Rationale**    | PRD identifies shock testing per IEC 60068-2-27 as a recommended supplementary qualification test beyond the 1.5 m drop-survival floor. |
| **Priority**     | Medium                                                              |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §13.4                                                           |
...
| **SRS-ENV-0011** | **Vibration Resistance**                                            |
| **Statement**    | The collar device should withstand vibration per IEC 60068-2-64 without loss of function. |
| **Rationale**    | PRD identifies vibration testing as a recommended supplementary qualification test, representative of sustained pet-motion vibration exposure. |
| **Priority**     | Medium                                                              |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §13.4                                                           |
...
| **SRS-ENV-0012** | **Enclosure UV Stabilization**                                      |
| **Statement**    | The collar device enclosure material shall be UV-stabilized to resist degradation from prolonged outdoor solar exposure over the product's service lifetime. |
| **Rationale**    | PRD requires the enclosure to be UV-stabilized but states no exposure duration or test method for the enclosure material. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Analysis                                                            |
| **Traceability** | PRD §12.5 · PRD — ABSENT                                           |
...
| **SRS-ENV-0013** | **CCF UV Aging Exposure**                                           |
| **Statement**    | The CCF shall withstand 2,000 hours of ultraviolet exposure per IEC 60068-2-5 without loss of function. |
| **Rationale**    | Bounds the accelerated UV-aging qualification program for the outdoor-worn CCF. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §12.5                                                           |
...
| **SRS-ENV-0015** | **Post-Thermal-Cycling Zone 2 Fuse-Force Window Retention**         |
| **Statement**    | Following completion of the thermal-cycling exposure specified in SRS-ENV-0003, the Zone 2 Fuse Tab breakaway force shall remain within its SKU-specific force window as defined in SRS-SAFE-0001, SRS-SAFE-0002, and SRS-SAFE-0003. |
| **Rationale**    | PRD explicitly ties CCF temperature cycling to the requirement that fuse force stays in-window. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §12.5 · SRS-ENV-0003 · SRS-SAFE-0001·0002·0003                  |
...
| **SRS-ENV-0016** | **Post-Thermal-Cycling Twist-Lock Detent-Torque Window Retention**  |
| **Statement**    | Following completion of the thermal-cycling exposure specified in SRS-ENV-0003, the Twist-Lock detent release torque shall remain within the torque window defined in SRS-INT-0044. |
| **Rationale**    | PRD explicitly ties CCF temperature cycling to the requirement that detent torque stays in-window. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §12.5 · SRS-ENV-0003 · SRS-INT-0044                             |
...
| **SRS-ENV-0017** | **Post-UV-Aging Zone 2 Fuse-Force Window Retention**                |
| **Statement**    | Following completion of the UV-aging exposure specified in SRS-ENV-0013, the Zone 2 Fuse Tab breakaway force shall remain within its SKU-specific force window as defined in SRS-SAFE-0001, SRS-SAFE-0002, and SRS-SAFE-0003. |
| **Rationale**    | Extends the same safety-critical retention obligation established for thermal cycling to the UV-aging qualification test. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | SRS-ENV-0013 · SRS-SAFE-0001·0002·0003 · SRS-ENV-0015               |
...
| **SRS-ENV-0018** | **Post-Chemical-Exposure Zone 2 Fuse-Force Window Retention**       |
| **Statement**    | Following completion of the chemical-fluid exposure specified in SRS-ENV-0014, the Zone 2 Fuse Tab breakaway force shall remain within its SKU-specific force window as defined in SRS-SAFE-0001, SRS-SAFE-0002, and SRS-SAFE-0003. |
| **Rationale**    | Extends the retention obligation to the chemical-resistance qualification test on the same safety-critical mechanism. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | SRS-ENV-0014 · SRS-SAFE-0001·0002·0003 · SRS-ENV-0015               |
...
| **SRS-RELI-0001** | **IP67 Rating Retention Over Full Service Lifetime**                |
| **Statement**    | The collar device, standalone and unmated from any CCF, shall retain its IP67 ingress-protection rating (SRS-HW-0003) for no less than 2 years of expected service life. |
| **Rationale**    | PRD states the qualitative criterion "IP67 full lifetime" without a numeric service-lifetime duration. The 2-year floor from the PCP is applied here as the qualification duration. |
| **Priority**     | Critical                                                            |
| **Stability**    | Stable                                                              |
| **Verification** | Analysis                                                            |
| **Traceability** | PRD §12.2 · PRD — ABSENT                                            |
...
| **SRS-RELI-0002** | **Collar Device Operational Availability**                          |
| **Statement**    | The collar device shall achieve an operational availability of no less than 99%, excluding any time during which the device is docked and charging. |
| **Rationale**    | PRD states "collar operational ≥99% (excl. charging)" as a direct numeric floor. Charging time is excluded because the device is intentionally non-operational during charging. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §12.2 · PRD — ABSENT                                            |
...
| **SRS-RELI-0003** | **Base Station Uptime**                                             |
| **Statement**    | The base station shall achieve an uptime of no less than 99.5%, measured over any rolling 90-day window. |
| **Rationale**    | PRD states "base ≥99.5% uptime over 90-day window" as a direct, fully-bounded numeric criterion for the mains-powered, continuously operating base station. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §12.2                                                           |
...
| **SRS-RELI-0004** | **OTA Update Success Rate**                                         |
| **Statement**    | The system shall achieve an OTA firmware update success rate of no less than 99%, measured as the proportion of initiated OTA installation attempts — on either a collar-mounted device or a base station — that complete successfully without invoking the dual-bank auto-revert defined in SRS-FUNC-0056. |
| **Rationale**    | PRD states "OTA success ≥99%" as a direct numeric floor on the aggregate reliability of the OTA mechanism. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §12.2                                                           |
...
| ID | Short Title | Priority | Stability | Verification |
|----|-------------|----------|-----------|--------------|
| SRS-UX-0001 | Pairing Completion Time | High | Stable | Test |
| SRS-UX-0002 | QR-Code OOB Pairing Method | High | Stable | Demonstration |
| SRS-UX-0003 | Pairing Mechanism Physical Design | High | Stable | Inspection |
| SRS-UX-0004 | Pairing LED Indication | High | Stable | Test |
| SRS-UX-0005 | Pairing Mode Auto-Exit | Medium | Stable | Test |
| SRS-UX-0006 | Twist-Lock Audible and Tactile Feedback | High | Stable | Test |
| SRS-UX-0007 | Twist-Lock Magnetic Assist | Medium | Stable | Test |
| SRS-UX-0008 | Twist-Lock Engage Force Limits | High | Stable | Test |
| SRS-UX-0009 | Device Removal Torque Limit | High | Stable | Test |
| SRS-UX-0010 | Charging Docking Success Rate | High | Stable | Test |
| SRS-UX-0011 | Asymmetric Keying Error-Proof Mating | High | Stable | Test |
| SRS-UX-0012 | LED State Indicators | High | Stable | Test |
| SRS-UX-0013 | LED Pattern Uniqueness | High | Stable | Test |
| SRS-UX-0014 | Color-Blind Friendly Indicators | Medium | Stable | Analysis |
| SRS-UX-0015 | Audible Click Sound Level | Medium | Stable | Test |
| SRS-UX-0016 | Base Station LED Functions | High | Stable | Test |
| SRS-UX-0017 | LED Auto-Dimming Mode | Low | Stable | Test |
| SRS-UX-0018 | Base Station Setup Time | High | Stable | Test |
| SRS-UX-0019 | CCF Variant Distinguishability | High | Stable | Inspection |
| SRS-UX-0020 | CCF Installation Time | High | Stable | Test |
| SRS-UX-0021 | CCF Fracture Indicator Visibility | High | Stable | Inspection |
| SRS-UX-0022 | Low-Battery LED Persistence | High | Stable | Test |
| SRS-UX-0023 | Fault State LED Indication | High | Stable | Test |
| SRS-UX-0024 | Input Confirmation Feedback | Medium | Stable | Test |
| SRS-UX-0025 | Battery State in Sync Payload | High | Stable | Test |
| SRS-UX-0026 | GNSS Interval in Status Payload | High | Stable | Test |
| SRS-UX-0027 | Breakaway Event Transmission | High | Stable | Test |
| SRS-UX-0028 | OTA State LED Indication | High | Stable | Test |
| SRS-UX-0029 | OTA LED Continuous Activity | Medium | Stable | Test |

<a id="req-ux-0001"></a>

|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-UX-0001** | **Pairing Completion Time**                                         |
| **Statement**    | The collar device shall complete BLE pairing and first-data-sync handshake with a companion app within 3 minutes of the user initiating pairing mode on the device, measured from pairing-mode-entry LED indication to app-confirmed-paired acknowledgment. |
| **Rationale**    | A 3-minute pairing window bounds the expected user wait time, after which the device auto-exits pairing mode. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §12.4                                                           |
...
|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-UX-0002** | **QR-Code OOB Pairing as Primary Method**                           |
| **Statement**    | The collar device shall support QR-code-based out-of-band (OOB) pairing as the primary pairing method, providing a scannable QR code that encodes the device identity for LE Secure Connections OOB pairing. |
| **Rationale**    | QR-code pairing simplifies the user experience by avoiding manual PIN entry or numeric comparison. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Demonstration                                                       |
| **Traceability** | PRD §5.6 · Bluetooth SIG LE Secure Connections                     |

<a id="req-ux-0003"></a>

|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-UX-0003** | **Pairing Mechanism Physical Design**                               |
| **Statement**    | The collar device shall provide a single, visually distinct, and user-accessible physical mechanism to initiate pairing mode, clearly labeled or icon-indicated on the device enclosure. |
| **Rationale**    | A single, labeled pairing button avoids user confusion about how to initiate pairing. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Inspection                                                          |
| **Traceability** | PRD §5.6                                                            |
...
|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-UX-0004** | **Pairing Mode LED Indication**                                     |
| **Statement**    | The collar device LED shall emit a visually distinct indication when the device is in pairing mode that is distinguishable from all other LED patterns defined in §14.3. |
| **Rationale**    | A unique pairing LED pattern enables the owner to confirm that the device has entered pairing mode. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | SRS-UX-0012                                                         |

<a id="req-ux-0005"></a>

|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-UX-0005** | **Pairing Mode Auto-Exit**                                          |
| **Statement**    | The collar device shall automatically exit pairing mode and revert to normal-operation LED indication after 3 minutes if no successful pairing is completed, with no user action required. |
| **Rationale**    | Prevents the device from remaining in pairing mode indefinitely, which would consume additional power. |
| **Priority**     | Medium                                                              |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | SRS-UX-0001                                                         |

<a id="req-ux-0006"></a>

|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-UX-0006** | **Twist-Lock Audible and Tactile Feedback**                         |
| **Statement**    | The Twist-Lock mechanism shall provide both an audible click and a tactile force-transition (detent drop) upon successful locking, enabling the user to confirm engagement by sound and feel without visual inspection. |
| **Rationale**    | Multi-modal feedback (audio + tactile) ensures the owner can confirm lock status without looking at the device. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.3.2a                                                      |
...
|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-UX-0007** | **Twist-Lock Magnetic Assist**                                      |
| **Statement**    | The Twist-Lock socket shall provide a magnetic-assist force that draws the device into correct alignment from a distance of ≤5 mm before the lug channels engage, reducing the fine-motor-skill demand of device docking. |
| **Rationale**    | Magnetic assist reduces the precision required during device alignment onto the CCF. |
| **Priority**     | Medium                                                              |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.3.2a                                                      |
...
|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-UX-0008** | **Twist-Lock Engage Force Limits**                                  |
| **Statement**    | The Twist-Lock engage force shall not exceed 5 N press-in axial force and 0.10 N·m rotational torque, enabling a typical adult user to dock the device without a tool or excessive effort. |
| **Rationale**    | Ergonomic bounds ensuring the Twist-Lock is usable by the full target population without excessive force. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.3.2a                                                      |
...
|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-UX-0009** | **Device Removal Torque Limit**                                     |
| **Statement**    | The device removal workflow shall require a detent-release torque not exceeding 0.15 N·m, such that an adult user can intentionally remove the device without a tool while the mechanism remains inertially immune. |
| **Rationale**    | Bounds removal torque so the device can be intentionally removed while maintaining inertial immunity during high-g pet motion. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.3.2a                                                      |
...
|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-UX-0010** | **Charging Docking Success Rate**                                   |
| **Statement**    | The magnetic pogo-pin charging connector shall achieve ≥90% first-attempt successful seating rate by a user with no prior training, measured in a usability test with a representative sample of ≥20 adult participants across age and dexterity ranges. |
| **Rationale**    | Bounds the docking usability to a measurable first-attempt success rate with a statistically significant test population. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.3.5                                                       |
...
|                  |                                                                     |
|------------------|---------------------------------------------------------------------|
| **SRS-UX-0011** | **Asymmetric Keying Error-Proof Mating**                            |
| **Statement**    | The Twist-Lock asymmetric lug keying shall physically prevent incorrect-orientation insertion of the device into the CCF socket, providing error-proof (poka-yoke) mating. |
| **Rationale**    | Prevents the owner from attempting to insert the device in the wrong orientation. |
| **Priority**     | High                                                                |
| **Stability**    | Stable                                                              |
| **Verification** | Test                                                                |
| **Traceability** | PRD §10.1.3.2a                                                      |
