...
| SRS-INT-0019 | Minimum Wi-Fi Uplink Signal Condition | Medium | Volatile | Test |
...
| SRS-INT-0036 | Charging Socket Self-Drainage | Medium | Volatile | Inspection |
| SRS-INT-0037 | Charging-Access Removal Rotation | High | Stable | Demonstration |
| SRS-INT-0038 | Device-Absent Socket Entrapment Geometry | High | Volatile | Test |
...
| SRS-INT-0056 | Base Station Payload Content Opacity | High | Stable | Test |
...
| **Stability** | Stable |
| **Verification** | Test |
| **Traceability** | SRS-INT-0009, SRS-HW-0019 |
